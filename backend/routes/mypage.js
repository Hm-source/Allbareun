...
router.post('/body/:id', auth , (req, res) => {
    const _bmi = BMI(req.body.weight, req.body.height);
    const _age = req.body.age;
    console.log(_bmi, _age, checkObesity(_bmi, _age));
...
router.patch('/body/:id', auth, (req, res) => {
    BodyInfo.findOneAndUpdate({user : req.user._id}, 
        {   weight: req.body.weight,
            ...
            age: req.body.age,
            state: checkObesity(BMI(req.body.weight, req.body.height), req.body.age)
        }, (err, result) => {
